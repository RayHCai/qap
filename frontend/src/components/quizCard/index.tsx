        ...
        <div className={ classes.cardContainer }>
            <div className={ classes.flexedContainer }>
                <div
                    ...
                    onClick={ () => navigate(`/dashboard/edit/${props.quiz.id}`) }
                >
                ...
                <div className={ classes.iconsContainer }>
                    <div className={ classes.iconContainer }>
                        { props.session ? (
                            <VscDebugStop
                                onClick={ () => props.stopSession(props.quiz.id) }
                            />
                        ) : (
                            <VscDebugStart
                                onClick={ () =>
                                    props.startSession(props.quiz.id)
                                }
                            />
                        ) }
                    </div>
                    ...
                    <div
                        ...
                        onClick={ () => props.deleteQuiz(props.quiz.id) }
                    >
                        <BsFillTrashFill />
                    </div>
                    ...
                    { props.session && (
                        <div
                            ...
                            onClick={ () =>
                                navigate(
                                    `/dashboard/session/${props.session!.id}`
                                )
                            }
                        >
                            <div className={ classes.iconContainer }>
